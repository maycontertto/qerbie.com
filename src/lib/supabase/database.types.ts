    ...
    Tables: {
      ...
      cash_register_sessions: {
        Row: {
          ...
          expected_pix_amount: number | null;
          counted_pix_amount: number | null;
          expected_card_amount: number | null;
          counted_card_amount: number | null;
          expected_other_amount: number | null;
          counted_other_amount: number | null;
