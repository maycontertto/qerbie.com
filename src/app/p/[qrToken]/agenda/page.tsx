...
import { CustomerPetAgendaBrowser } from "@/app/p/[qrToken]/agenda/CustomerPetAgendaBrowser";

export default async function PetShopAgendaPage({
  params,
}: {
