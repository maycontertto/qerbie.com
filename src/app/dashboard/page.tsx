  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-linear-to-b from-zinc-50 to-white dark:from-zinc-950 dark:to-zinc-900">
      ...
      <main className="relative mx-auto max-w-7xl px-4 py-10 sm:px-6">
        <div className="rounded-2xl border border-zinc-200 bg-white/80 p-8 shadow-sm backdrop-blur dark:border-zinc-800 dark:bg-zinc-900/70 sm:p-10">
          ...
          <div className="mt-5 flex flex-wrap items-center gap-3">
            <Link
              ...
              className="inline-flex items-center justify-center rounded-lg border border-zinc-200 bg-white/70 px-4 py-2.5 text-sm font-semibold text-zinc-800 hover:bg-white dark:border-zinc-800 dark:bg-zinc-900/50 dark:text-zinc-100 dark:hover:bg-zinc-900"
            >
          ...
          {billingBanner && (
            <div
              className={`mt-4 flex flex-wrap items-center justify-between gap-3 rounded-lg border p-4 text-sm ${
            ...
            >
              ...
              <Link
                href="/dashboard/pagamento"
                className="rounded-md border border-current/20 bg-white/60 px-3 py-1.5 text-sm font-semibold text-zinc-900 hover:bg-white dark:bg-zinc-900/40 dark:text-zinc-50 dark:hover:bg-zinc-900"
              >
                Pagamento
              </Link>
            </div>
            ...
            <section className="mt-10">
              ...
              <div className="mt-6 grid gap-4 sm:grid-cols-3">
                ...
                {activeSection === "historico" && (
                  <>
                    <div className="sm:col-span-3 rounded-lg border border-zinc-200 p-6 dark:border-zinc-700">
                      <div className="flex flex-wrap items-center justify-between gap-3">
                        <div>
                      ...
                      {!canSales ? (
                        <div className="mt-4 rounded-lg border border-zinc-200 bg-zinc-50 p-4 text-sm text-zinc-700 dark:border-zinc-800 dark:bg-zinc-900/40 dark:text-zinc-300">
                              ...
                              <div className="mt-4 space-y-2">
                                {(history?.topProducts?.length ?? 0) > 0 ? (
                                  history!.topProducts.map((p) => (
                                    <div
                                      key={p.name}
                                      className="flex items-center justify-between gap-3 rounded-md bg-zinc-50 px-3 py-2.5 text-sm text-zinc-800 dark:bg-zinc-800/40 dark:text-zinc-200"
                                    >
                                ...
                                {(history?.salesByAttendant?.length ?? 0) > 0 ? (
                                  history!.salesByAttendant.map((a) => (
                                    ...
                                    >
                                      ...
                                      <div className="shrink-0 text-sm font-semibold text-zinc-600 dark:text-zinc-300">
                                        {formatBrl(a.total)}
                                      </div>
                                    </div>
                                  ))
