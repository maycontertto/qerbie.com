...
export function FaceCaptureField() {
  ...
  return (
    <div className="rounded-xl border border-zinc-200 bg-white p-3 dark:border-zinc-800 dark:bg-zinc-900">
      ...
      <input ref={inputRef} type="file" name="image" accept="image/*" capture="user" className="hidden" />
      ...
      <div className="mt-2 grid grid-cols-2 gap-2">
        ...
        <button
          ...
          disabled={!cameraOpen}
          className="rounded-xl border border-zinc-200 bg-white px-3 py-2 text-sm font-semibold text-zinc-900 hover:bg-zinc-50 disabled:cursor-not-allowed disabled:opacity-50 dark:border-zinc-800 dark:bg-zinc-900 dark:text-zinc-50 dark:hover:bg-zinc-800"
        >
          Capturar foto
        </button>
      </div>
