...
export default async function QrModulePage({
  searchParams,
}: {
      ...
      <div className="min-h-screen">
        <main className="mx-auto max-w-3xl px-4 py-10 sm:px-6">
          <div className="rounded-2xl border border-zinc-200 bg-white/70 p-8 shadow-sm backdrop-blur dark:border-zinc-800 dark:bg-zinc-900/60">
            ...
            <h1 className="mt-4 text-2xl font-semibold text-zinc-900 dark:text-zinc-50">QR Code</h1>
      ...
      <main className="mx-auto max-w-7xl px-4 py-10 sm:px-6">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <h1 className="mt-3 text-2xl font-semibold text-zinc-900 dark:text-zinc-50">QR Code</h1>
            <p className="mt-1 text-sm text-zinc-500 dark:text-zinc-400">
              Gere um QR para o cliente escanear no celular (ou use no próprio aparelho).
            </p>
          </div>
          ...
          <div className="rounded-2xl border border-zinc-200 bg-white/70 p-5 shadow-sm backdrop-blur dark:border-zinc-800 dark:bg-zinc-900/60">
            <div className="flex flex-wrap items-center justify-between gap-3">
              <div>
                ...
                <p className="mt-1 text-sm text-zinc-500 dark:text-zinc-400">
                  Crie um atendimento e selecione “Ver QR” para deixar exposto.
                </p>
              </div>
            </div>
            ...
            <div className="mt-4 grid gap-4 sm:grid-cols-2">
              <div className="rounded-xl border border-zinc-200 bg-zinc-50 p-4 dark:border-zinc-800 dark:bg-zinc-950">
                <h3 className="text-sm font-semibold text-zinc-900 dark:text-zinc-50">Atendimento rápido (QR)</h3>
                    ...
                    {(tables ?? []).map((t) => (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <a
                            href={`/dashboard/modulos/qr?qr=${encodeURIComponent(t.qr_token)}`}
                          ...
                          <a
                            href={`${origin}/t/${encodeURIComponent(t.qr_token)}${t.label.toLowerCase().startsWith("atendimento") ? "?quick=1" : ""}`}
