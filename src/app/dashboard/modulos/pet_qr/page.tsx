...
import { createPetQrToken, deactivatePetQrToken } from "@/lib/pet/actions";
...
export default async function PetQrPage({
  ...
  const activeCustomerUrl = activeQrToken ? `${origin}/p/${encodeURIComponent(activeQrToken)}` : null;
          ...
          <div className="rounded-2xl border border-zinc-200 bg-white/70 p-5 shadow-sm backdrop-blur dark:border-zinc-800 dark:bg-zinc-900/60">
            ...
            <div className="mt-4 grid gap-4 sm:grid-cols-2">
              <div className="rounded-xl border border-zinc-200 bg-zinc-50 p-4 dark:border-zinc-800 dark:bg-zinc-950">
                ...
                <form action={createPetQrToken} className="mt-3 space-y-3">
                  <input type="hidden" name="return_to" value="/dashboard/modulos/pet_qr" />
                  <input
                    name="label"
                    type="text"
                    defaultValue="Pet Shop"
                    ...
                    {(tokens ?? []).map((t) => (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-3">
                          {t.is_active ? (
                            <form action={deactivatePetQrToken}>
                              <input type="hidden" name="return_to" value="/dashboard/modulos/pet_qr" />
                          ...
                          <a
                            href={`/dashboard/modulos/pet_qr?qr=${encodeURIComponent(t.qr_token)}`}
                          ...
                          <a
                            href={`${origin}/p/${encodeURIComponent(t.qr_token)}`}
