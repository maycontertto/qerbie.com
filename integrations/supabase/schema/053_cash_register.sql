...
create table if not exists public.cash_register_sessions (
  ...
  expected_pix_amount numeric(12,2),
  counted_pix_amount numeric(12,2),
  expected_card_amount numeric(12,2),
  counted_card_amount numeric(12,2),
  expected_other_amount numeric(12,2),
  counted_other_amount numeric(12,2),
  closing_notes text,
